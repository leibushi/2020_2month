...
def Insert_Data(cat_ids):
    ...
    for cat_id in cat_ids:
        ...
        print(cat_id)
        # 两个表都要改，以免出错
        select_sql = '''INSERT IGNORE INTO taobao_item_202000306 SELECT * FROM taobao_item_202002028_copy1 WHERE category_id=%s;'''
...
异常 Failed to parse: {"code":111,"data":[],"msg":"请2秒后再试","success":false}
"""